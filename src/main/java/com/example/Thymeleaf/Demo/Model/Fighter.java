...
// =========================================================================================
// A NEW FIGHTER ENTERS THE DATABASE! 

// TELLS JPA THIS CLASS IS A DATABASE ENTITY
@Entity

// MAPS THIS CLASS TO THE "fighters" TABLE
// NOTE - HIBERNATE CREATES IT IF IT DOESN'T EXIST
@Table(name = "fighters")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class Fighter {
    ...
    // PRIMARY KEY IS AUTO-INCREMENTED BY THE DATABASE
    @Id
